<template lang="pug">
    form(:class="device ? `header__search ${device}` : 'header__search'")
        input.header__search-input(type="text" placeholder="Buscar")
        button.header__search-btn
            svg.header__search-svg(viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg")
