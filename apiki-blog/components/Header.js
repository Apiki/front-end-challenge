...
const user = {
    ...
    imageUrl:
        'https://media-exp1.licdn.com/dms/image/C4E03AQEnsZvNoLfQAA/profile-displayphoto-shrink_800_800/0/1598467553480?e=1664409600&v=beta&t=u_aD-JH-TM2GYzjmlPujnyhmgWVzLawRjF36oYyEOFc',
}
const navigation = [
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="hidden md:block">
                                            <div className="ml-10 flex items-baseline space-x-4">
                                                {navigation.map((item) => (
                                                    <a
                                                        target={item.target ? '_Blank' : 'self'}
                                                        key={item.name}
                                                        href={item.href}
